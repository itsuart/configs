...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-function-name-face ((,class (:foreground ,gandalf-blue-1 :bold f))))
   `(font-lock-keyword-face ((,class (:foreground ,gandalf-fg :bold f))))
   ...
   `(font-lock-string-face ((,class (:foreground ,gandalf-green-1  :bold f))))

   `(font-lock-type-face ((,class (:foreground ,gandalf-blue-2))))
   `(font-lock-variable-name-face ((,class (:foreground ,gandalf-cyan-1))))
   `(font-lock-warning-face ((,class (:bold f :foreground ,gandalf-fg))))
   ...
   `(ido-first-match ((,class (:foreground ,gandalf-fg :background ,gandalf-gray-8 :bold f))))
   `(ido-only-match ((,class (:foreground ,gandalf-green-1 :background ,gandalf-bg))))
   `(ido-subdir ((,class (:foreground ,gandalf-white-1 :background ,gandalf-blue-5 :bold f))))
   ...
   `(eshell-prompt ((,class (:foreground ,gandalf-green-1 :bold f))))
